...
const NECK_FRAC := {
	"front": {1: 0.137, 2: 0.115, 3: 0.095, 4: 0.119, 5: 0.098, 6: 0.064, 7: 0.058, 8: 0.108, 9: 0.037},
	"back": {1: 0.076, 2: 0.069, 3: 0.066, 4: 0.078, 5: 0.074, 6: 0.063, 7: 0.052, 8: 0.063, 9: 0.044},
	"left": {1: 0.118, 2: 0.113, 3: 0.115, 4: 0.105, 5: 0.091, 6: 0.121, 7: 0.075, 8: 0.122},
}
